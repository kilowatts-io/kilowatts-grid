...
import { calculateCycleSeconds } from "@/src/utils/misc";

export const ForeignMarket: React.FC<ForeignMarketPointInTime> = (f) => {
    ...
    <>
      ...
      <>
        {f.interconnectors.map((i) => {
          ...
          const width = calculateSizePx(i.capacity);
