...
export const BOTTOM_SCREEN_FRACTION = 0.5

export const ICON_LIST_WIDTH = 15;
export const ICON_LIST_HEIGHT = 15;
...
const HIGHLIGHT_CIRCLE_RADIUS_GW_EQUIVALENT = 2
export const HIGHLIGHT_CIRCLE_RADIUS = HIGHLIGHT_CIRCLE_RADIUS_GW_EQUIVALENT * ICON_SIZE_PX_TO_CAPACITY_MW * 1000
...
export const HIGHLIGHTED_FOCUS_SCALE = 2.5;
export const HIGHLIGHTED_FOCUS_SCALE_OFFSET = - 100

// cables

export const CABLE_COLOR = "black";
export const ELECTRON_COLOR = "yellow";
// export const ELECTRON_WIDTH_TO_CAPACITY_RATIO = 0.5;
