...
def get_unitgroup_fueltype():
    return pd.Series({unit_group.details.code: unit_group.details.fuel_type for unit_group in unit_groups})

def get_unitgroup_coords():
    return pd.DataFrame({unit_group.details.code: [unit_group.details.coords.lat, unit_group.details.coords.lng] for unit_group in unit_groups}).T
